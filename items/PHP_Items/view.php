                    ...
                    <div class="col l-12 m-12 c-12">
                        <div class="row">
                            <div class="card__header col l-12 m-12 c-12">
                                <h1 class="card__title">Thông tin sản phẩm</h1>
                            </div>
                        </div>
                        <div class="card__body">
                            <form class="row" method="POST" name="items-form" id="items-form" enctype="multipart/form-data">
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="itemNo" required value="<?php echo $row_up['itemNo'];?>">
                                ...
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="itemName" required value="<?php echo $row_up['itemName'];?>">
                                        <label>Tên sản phẩm<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="otherName" value="<?php echo $row_up['otherName'];?>">
                                        <label>Tên khác</label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="colorId" value="<?php echo $row_up['colorId'];?>">
                                        <label>Mã màu sắc</label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="makeId" value="<?php echo $row_up['makeId'];?>">
                                        <label>Mã nhà sản xuất<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number" name="qty_available" value="<?php echo $row_up['qty_available'];?>">
                                        <label>Số lượng<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number" name="qtyOnOrder" value="<?php echo $row_up['qtyOnOrder'];?>">
                                ...
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text" name="location" value="<?php echo $row_up['location'];?>">
                                        <label>Vị trí trong kho</label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="text"name="usefor" value="<?php echo $row_up['usefor'];?>">
                                        <label>Sử dụng cho</label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number"name="cost" value="<?php echo $row_up['cost'];?>">
                                        <label>Giá nhập<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number"name="price" value="<?php echo $row_up['price'];?>">
                                        <label>Giá bán lẻ<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number"name="wholeSalePrice" value="<?php echo $row_up['wholeSalePrice'];?>">
                                        <label>Giá bán buôn<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number"name="specialPrice" value="<?php echo $row_up['specialPrice'];?>">
                                        <label>Giá đặc biệt<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                        <input disabled type="number"name="tax"value="<?php echo $row_up['tax'];?>">
                            ...
                            <div class="row">
                                <div class="col l-12 m-12 c-12">
                                    <button onclick="window.location.href='index.php?page_layout=edit&id=<?php echo $row_up['itemNo'];?>';" class = "form__button" >Sửa thông tin sản phẩm</button>
                                </div>
                            </div>
                        </div>
                    </div>
